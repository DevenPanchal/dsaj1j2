 ...
 */
public class TusharRedBlackTree {
	...
	private void inOrderTraverseRedBlackTree(Node root, int space) {

		if (root == null || root.isNullLeaf) {
			return;
		}
		inOrderTraverseRedBlackTree(root.left, space + 5);

		for (int i = 0; i < space; i++) {
			System.out.print(" ");
		}
		System.out.println(root.data + " " + (root.color == Color.BLACK ? "B" : "R"));
		inOrderTraverseRedBlackTree(root.right, space + 5);
	}

	public static void main(String args[]) {
		Node root = null;
		TusharRedBlackTree redBlackTree = new TusharRedBlackTree();
		...
		root = redBlackTree.insert(root, 22);
		...
		redBlackTree.inOrderTraverseRedBlackTree(root, 0);

		System.out.println("Deleting 18, 11, 3, 10, 22");

		root = redBlackTree.delete(root, 18);
		System.out.println(redBlackTree.validateRedBlackTree(root));
		root = redBlackTree.delete(root, 11);
		System.out.println(redBlackTree.validateRedBlackTree(root));
		root = redBlackTree.delete(root, 3);
		System.out.println(redBlackTree.validateRedBlackTree(root));
		root = redBlackTree.delete(root, 10);
		System.out.println(redBlackTree.validateRedBlackTree(root));
		root = redBlackTree.delete(root, 22);

		redBlackTree.inOrderTraverseRedBlackTree(root, 0);

		System.out.println();
		System.out.println(
				"THIS OUTPUT MATCHES THE EXPECTED OUTPUT ON GEEKS FOR GEEKS RED BLACK TREE DELETE. Check README for details on the expected output.");
		System.out.println(
				"Remaining statements below are original inputs from Tushar's code. They are commented out because the result could not be validated anywhere else.");

		/*
		 * System.out.println(redBlackTree.validateRedBlackTree(root)); root =
		 * redBlackTree.insert(root, 10); root = redBlackTree.insert(root, 15); root =
		 * redBlackTree.insert(root, -10); root = redBlackTree.insert(root, 20); root =
		 * redBlackTree.insert(root, 30); root = redBlackTree.insert(root, 40); root =
		 * redBlackTree.insert(root, 50); root = redBlackTree.insert(root, -15); root =
		 * redBlackTree.insert(root, 25); root = redBlackTree.insert(root, 17); root =
		 * redBlackTree.insert(root, 21); root = redBlackTree.insert(root, 24); root =
		 * redBlackTree.insert(root, 28); root = redBlackTree.insert(root, 34); root =
		 * redBlackTree.insert(root, 32); root = redBlackTree.insert(root, 26); root =
		 * redBlackTree.insert(root, 35); root = redBlackTree.insert(root, 19);
		 * redBlackTree.printRedBlackTree(root);
		 * 
		 * root = redBlackTree.delete(root, 50);
		 * System.out.println(redBlackTree.validateRedBlackTree(root)); root =
		 * redBlackTree.delete(root, 40);
		 * System.out.println(redBlackTree.validateRedBlackTree(root)); root =
		 * redBlackTree.delete(root, -10);
		 * System.out.println(redBlackTree.validateRedBlackTree(root)); root =
		 * redBlackTree.delete(root, 15);
		 * System.out.println(redBlackTree.validateRedBlackTree(root)); root =
		 * redBlackTree.delete(root, 17);
		 * System.out.println(redBlackTree.validateRedBlackTree(root)); root =
		 * redBlackTree.delete(root, 24);
		 * System.out.println(redBlackTree.validateRedBlackTree(root)); root =
		 * redBlackTree.delete(root, 21);
		 * System.out.println(redBlackTree.validateRedBlackTree(root)); root =
		 * redBlackTree.delete(root, 32);
		 * System.out.println(redBlackTree.validateRedBlackTree(root)); root =
		 * redBlackTree.delete(root, 26);
		 * System.out.println(redBlackTree.validateRedBlackTree(root)); root =
		 * redBlackTree.delete(root, 19);
		 * System.out.println(redBlackTree.validateRedBlackTree(root)); root =
		 * redBlackTree.delete(root, 25);
		 * System.out.println(redBlackTree.validateRedBlackTree(root)); root =
		 * redBlackTree.delete(root, 17);
		 * System.out.println(redBlackTree.validateRedBlackTree(root)); root =
		 * redBlackTree.delete(root, -15);
		 * System.out.println(redBlackTree.validateRedBlackTree(root)); root =
		 * redBlackTree.delete(root, 20);
		 * System.out.println(redBlackTree.validateRedBlackTree(root)); root =
		 * redBlackTree.delete(root, 35);
		 * System.out.println(redBlackTree.validateRedBlackTree(root)); root =
		 * redBlackTree.delete(root, 34);
		 * System.out.println(redBlackTree.validateRedBlackTree(root)); root =
		 * redBlackTree.delete(root, 30);
		 * System.out.println(redBlackTree.validateRedBlackTree(root)); root =
		 * redBlackTree.delete(root, 28);
		 * System.out.println(redBlackTree.validateRedBlackTree(root)); root =
		 * redBlackTree.delete(root, 10);
		 * System.out.println(redBlackTree.validateRedBlackTree(root));
		 */
